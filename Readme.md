...
> We try to make sure that we're intentional about informal communication, want to make sure that we stimulate informal communication because that tends to get lost if you're remote. Sid Sijbrandij, GitLab
